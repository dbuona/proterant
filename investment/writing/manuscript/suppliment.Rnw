...
\title{Supporting Information for: Aridity and pollination success contribute to flowering-first phenological sequences in a major North American temperate tree clade} %emw: check title if you change it
\date{}
\begin{document}
