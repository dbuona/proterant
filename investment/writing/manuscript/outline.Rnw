...
%emwmar9 -- I would do some flipping here ... suggested edits commented out below: 
% First, get to the answers to the hypotheses! You set the readers up well, so get to the punchline!
...
%emwmar9 -- add a sentence at the end here that gives a nod to the high intraspecific variation. 


%emwmar9 -- suggest new subheading with this in it. May need to go later in intro IMHO. 
...
The direction associations between pdsi and flower-leaf sequences follow the expectations the water limitation hypothesis, with hysteranthous species occupying generally drier area. %emwmar9 -- shorten next paragraph and merge to this one?
...
%emwmar9 -- getting a little wordy.... try to make this simpler for readers, especially the topic sentence and I would shorten this -- you list two studies that seem to have the same info on hydraulic properties of flowers/leaves -- merge them so they are one short sentence and maybe avoid words like 'xylem conductivity'
...
%emwmar9 -- shortened versions of the next three paragraphs would nicely merge to new version of previous paragraph ... 
To better understand this, we must consider the flower-leaf sequences in the context of the full season phenological cycle of the clades we studied in comparison to the taxa that display this habit in the dry deciduous forest of neotropics (do we still say this word or is it colonialist?). %emwmar9  -- I haven't seen complaints ... yet and I don't have a better word
...
%emwmar9 -- in this study, we provide a super cool case study and suggest people should run with it! Try more clades, figure this out ... it's exciting and important ... 
...
%emwmar9 -- below sentence could be at start of discussion. Not clear to me that the paper needs the second sentence ... anywhere. 
