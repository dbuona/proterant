...
%\usepackage{xr-hyper}
\usepackage{hyperref}
\title{Aridity and floral display drive hysteranthous flowering in the North American cherries (\textit{Prunus spp.})}
