...
To better understand how within season dynamics affected our inference, we also repeated this procedure without including day of season as a predictor. 
...
We found substantial inter-specific differences in flower-leaf sequences within the American plums (Fig. \ref{fig:ordinals}. b). 

Based on our flower leaf sequence index, some species (\textit{P. mexicana}, \textit{P. umbellata} and \textit{P. angustifolia}) were likely to be hysteranthous 
across their flowering season. Two species (\textit{P. maritima} and \textit{P. gracilis}), were likely to be hysteranthous for much of their flowering period, but had a  

(\textit{P. alleghaniensis}, \textit{P. nigra}, \textit{P. rivularis}, \textit{P. subcordata}, and \textit{P. texana}) were always most likely to flower after leaves developed (Fig. \ref{fig:phylo2}b). All other species displayed intermediate phenotypes, with four species mostly likely to hysteranthous at the start of the season (\textit{P. americana}, \textit{P. hortulana}, \textit{P. munsoniana} and ), one species through early season () and one species through mid season () (Fig \ref{fig:phylo2}b).
