...
z_i &= \alpha+ \alpha_{phylo}+ \beta_{PDSI}*X_{PDSI}+\beta_{\text{floral investment}}*X_{flowers/inflorescence}+\epsilon_i$\\ % write this with interaction
