...
\section*{Discussion}
In this\linelabel{style1} study, we show that hysteranthous flowering can be linked to both aridity tolerance and pollinator attraction.% through the predictions of the water limitation and insect visibility hypotheses, clarifying something important
