...
%emw22Oct -- I only quickly skimmed but this sort of verbiage with no actual mention of WHAT you did is not so great to me. You have the right friendly verbiage for a response to reviewers, but you need to condense it to say more clearly: we did X, Y, and Z and we find the same thing. The paper is better and you can read more below. 
...
Both reviewers raised the potentially issue of climate change affecting the patterns of flower-leaf sequences we sought to quantify, and for this reason, we have now included year of observation as a co-variate in our main model. Following convention from phenological change studies we, used 1980 as a hinge. We detail these methods in lines \lineref{hinge1}-\lineref{hinge2}. In this case, year did not have a significant effect on patterns of hysteranthy. %emw22Oct -- way to bury the lead! You need to say this upfront: both reviewers said this, we addressed it, it did not matter ... so this means that ... then you can explain the lines and methods a touch. 

We have also added a paragraph to our Discussion regarding this point in lines \lineref{climo1}-\lineref{climo2}.
...
%emw22Oct -- you could cut some wordiness in your letter. 'We also would like to highlight that one of the ... ' --> A major reason we chose these models is ... 
...
%emw22Oct -- 'We want to highlight that ' --> delete
...
In the revised version of the changed our verbal descriptions of the vegetative BBCH stages to more closely align with how they are described in \citet{Finn2007}. These changes can be found at lines \lineref{conty1}-\lineref{conty2}.
...
%emw22Oct -- I am only skimming, but this is some new voice you have! I think it sounds a little daft for you.... too many 'really' for me. Sound more authoritative as you are damn good at this topic. Something like, great question -- to address it you need XYZ, we say this now here (even if you said it before the revisions!). 
We agree there is a potentially interesting relationship between hysteranthy and flowering duration and time of flowering. We now mention this more explicit in our paper at line \lineref{fiver}. We think this is a really interesting question to pursue further, to do so, we think you would really need to understand both spatial bias in the dataset and  species-level differences in range size, which we think is beyond the capacity of our models to account for in this context. 
...
Thanks. We have made these formatting changes. \textbf{TO DO} %emw22Oct -- oy! I bet this *is* someone who checks for typos in the journal list. 
...
%emw22Oct --  wait, did you plagiarize yourself (see above) here? 
