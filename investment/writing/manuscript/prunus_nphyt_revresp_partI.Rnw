...
This is a good point. We have modified the title to better reflect our study system. The title of the manuscript is now: 
...
\begin{quote} \textbf{Paste new text here} \end{quote}
...
We appreciate this point. Our samples to span many decades of collection (X-Y), which is necessary to generate a large enough sample size to give our analyses statistical power. \textbf{We have added this information.}

Both reviewers raised the potentially issue of climate change affecting the patterns of flower-leaf sequences we sought to quantify, and for this reason, we have now included year of observation as a co-variate in our main model. Following convention from phenological change studies we, used 1980 as a hinge. With this approach year did not have a significant effect on patterns of hysteranthy, which is consistent with recent large-scale observations that despite advances in both flowering and leafout, the interval between these phases has remained relatively stable \citep{}. 
...
We agree this would make our text easier to follow and have added a more concrete explaination of this scale to our Methods.
...
We agree, and have added this an explanation of PDSI to the Methods.
...
We appreciate the reviewer's clear summary of the different ways selection and operate on flower leaf sequence.
We found this framing very helpful and have added it to our introduction of the hypotheses.

We included the fruit maturation hypothesis in our original submission because it has been explicity stated in the literature, but we agree with the reviwers point that this hypothesis better aligns with out null explanations than the two hpyotheses that we treat in greater detail. Because of this point, and the fact that we had low confidence in the inference from our fruit size analyses due to sample size limitations, in our revised manuscript we now mention this hypothesis as an example of our null hypotheses (\textbf{lines X}), and have removed our tests of it from our analyses.
...
We agree that the insect visibility hypothesis feels overly simplistic. We feel this is inpart because it has not been well developed in the literature. We with the reviewer's alternative presentation of how selection could operate to increase the size of hysteranthous flower and we had infact presented the hypothesis this was in previous drafts of our submission. We now present the possibilities for both the positive and negative associations between hysteranthy and floral display size in our revised manuscript and include additional citations to better anchor them in the literature. 
...
We agree with the Reviewer that our ideal model would include both traits as a predictors and their interactions to better understand their additive and interactive relationship to flower-leaf sequences. However, our data does not proved a straight-forward was to do this as FLS, PDSI and petal size were measured on different individual and have different sample sizes (FLS:1009, PDSI: Petal). 
...
This concern was shared by Reviewer 1, and we agree that developing this five level index masked important variation that could be captured in a continuous index. In this version, we now provide a continuous index (detailed in lines X-X), and redone all of our analyses with this metric.
...
This is an important point. We have ammended this statement.
...
We can't. THIS IS NOT AN OBSERVATIONAL STUDY.
