...
We think the these changes suggested by the reviewer have made our methods much easier to follower, even without an additional visual aid. However if the reviewer still feels that a conceptual figure would enhance the clarity of the study, we would consider this further. %emwNov18 -- you're killing it Dan!
