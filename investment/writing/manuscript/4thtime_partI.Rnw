...
%emw17Feb -- you sound just a touch pissy (`multiple times', `you requested'...); understandable but not the way to make the editor love you. I edited the below but please make sure it's accurate.
