...
Because single-predictor regressions can be formulated with either variable as the dependent one (say better and cite),  this allowed us to both account for variation in within species PDSI and petal lengths and account for the phylogenetic structure of these variables as well. (Should everything below go to the supplement?)
