...
prunocerasus<-dplyr::filter(sp, specificEpithet %in% pruno)
...
prunocerasus<-dplyr::left_join(prunocerasus,geoCounty,by=c("county","stateProvince")) ## This assigns each country coordinates
