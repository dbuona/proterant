...
\indent While the adaptive story of hysteranthy is common in the literature, it should not be taken for granted that hysteranthy is, in and of itself, a functional trait under selection. The hysteranthous pattern could simply be a by-product of other, independent selective regimes acting with differential stength on floral and foliate phenology. With this null model formulation, the hysteranthous pattern is, itself, insignificant and simply a necessary consequence of selection for extremely early flowering.\\
