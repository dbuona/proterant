...
namelist<-c("Prunus_pensylvanica","Prunus_virginiana","Acer_rubrum","Acer_pensylvanicum",
          "Viburnum_acerifolium","Ilex_mucronata","Ilex_verticillata","Vaccinium_corymbosum","Corylus_cornuta",
...
d<-dplyr::filter(d,!GEN.SPA%in% c("ACE.SAC","BET.ALL","AME.SPP","BET.SPP")) # remvoe species with no FLS data

d$taxa<-c("Acer_pensylvanicum","Acer_rubrum","Comptonia_peregrina","Corylus_cornuta","Ilex_mucronata","Ilex_verticillata",
          "Prunus_pensylvanica","Prunus_virginiana","Vaccinium_corymbosum","Viburnum_acerifolium") # add a cloumn matching the tree name formate
