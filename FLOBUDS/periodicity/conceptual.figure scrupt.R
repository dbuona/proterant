...
plot.list <- lapply(list(flat,covarying,noncovarying,noncovarying), 
                    function(p) p + theme(plot.background = element_rect(color = "black")))
jpeg("~/Documents/git/proterant/FLOBUDS/Plots/periodicity_figures/designs.jpeg",width = 10,height=10,unit="in",res=300)
