...
\\\\
\noindent{Dear Dr. Ellison,}\\ % EMW20Mar -- Good letter!
\vspace{1.5ex}
...
% EMW20Mar -- need to break up really long sentence, one idea below. 
...
% EMW20Mar -- I am not sure you need the below paragraph ... if you keep it, fix 'has potentially to substantially' and I would shorten it (I think don't mention books; it makes the paper sound textbook-y dull, when it's not)
