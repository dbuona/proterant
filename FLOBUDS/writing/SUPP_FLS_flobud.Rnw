...
library(xtable)
xtable(able,caption = "Comparisions between the average amount of chilling accumulated by woody plants at Harvard Forest between 15-October and 15-April in the field and our experimental treatments using three alternative methods for calculating chilling.",label ="tab:chillcomps")
@
