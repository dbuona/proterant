...
library(xtable)
xtable(able,caption = "Comparisons between the average amount of chilling accumulated by woody plants at Harvard Forest (Petersham, MA, USA) between 15 October and 15 April in the field (Harvard Forest) and our experimental treatments (Chamber 30 days, Chamber 60 days)  using three alternative methods for calculating chilling. See Materials and Methods for further details.", label ="tab:chillcomps") % EMW5Dec20: Harvard is mis-spelled in column name, also you should be able to remove the underscores in the column names.
@
...
xtable(fixef(mod.bb.int,probs = c(.025,.25,.75,.975)),caption = " Mean effects of forcing temperature, chilling duration, and photoperiod and all two-way interactions on budburst of 10 woody plant species",label ="tab:modelests")
xtable(fixef(mod.flo.int,probs =  c(.025,.25,.75,.975)),caption = " Mean effects of forcing temperature, chilling duration, and photoperiod and all two-way interactions on flowering of 10 woody plant species",label ="tab:modelests2" )
...
xtable(phh2,caption = "Mean effects of forcing temperature on the phenology of flower and leaf buds of 10 temperate woody plany species when under long photoperiod and long chilling duration experimental treatments ",label ="tab:phh" )
