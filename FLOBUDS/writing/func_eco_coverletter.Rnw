\documentclass[11.75 pt]{article}
...
\noindent The relative timing of flower and leaf emergence in the spring strongly influences the ecology of many temperate systems, determining growing season length and the timing of critical resources for pollinators and herbivores. For deciduous woody plants the order and duration of flower-leaf sequences (FLSs) shapes both reproductive fitness and physiological functioning, yet we still do not know how the environment determines FLS across species and years. Shifts in FLS with climate change suggest that there must be differences in how these phases respond to environmental cues, which are critical to both the basic biology of FLSs and to predicting the magnitude and---ultimately---fitness impacts of FLS shifts with climate change
