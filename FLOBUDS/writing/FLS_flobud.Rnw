...
flochill<-round(flo.eff[2,1],digits=2)
flolight<-round(flo.eff[3,1],digits=2)
floforce<-round(flo.eff[4,1],digits=2)
flochillXlight<-round(flo.eff[5,1],digits=2)
flochillXforce<-round(flo.eff[6,1],digits=2)
flolightXforce<-round(flo.eff[7,1],digits=2)

bbchill<-round(bb.eff[2,1],digits=2)
bblight<-round(bb.eff[3,1],digits=2)
bbforce<-round(bb.eff[4,1],digits=2)
bbchillXlight<-round(bb.eff[5,1],digits=2)
bbchillXforce<-round(bb.eff[6,1],digits=2)
bblightXforce<-round(bb.eff[7,1],digits=2)
...
% DB 0ct 19 need to switch numbers above to Sweave
...
xtable(fixef(mod.flo.int,probs = c(.25,.75)),caption = "Phenological sensitivity of leaf (top) and flower (bottom) buds to environmental cues. Caption needs work.",label ="tab:modelests" )
...
xtable(phh2,caption = "Phenological sensitivity of leaf and flower buds to forcing at high levels of chilling and forcing. Caption needs work.",label ="tab:phh" )
