...
@
\maketitle
\section*{Abstract}  % EMW5Dec20: Some edits see what you think...
...
% EMW5Dec20: Some small edits here
...
% EMW5Dec20: Reads much better now!
...
% EMW5Dec20: Some edits to check closely
\noindent The clarity of these signatures from each hypothesis, however, may be obscured in certain situations. First, a species' buds could be both differentially sensitive to photoperiod or chilling (supporting the DSH) and also respond to forcing in a forcing hierarchy (that is, both hypotheses can operate at once, see Fig. \ref{fig:simulations} b.). Second, the differential sensitivity framework can generate this signature of the FHH when other cues are at high levels due to interactions between the chilling response and thermal requirement (see Fig. \ref{fig:simulations} c., chill x force interaction). When this happens the FHH would effectively be a special case of the DSH. That is, the presence of FHH does not exclude the DSH \citep{Gariglio2006}.\\ % EMW5Dec20: I like the way it reads but you don't present the FHH as special case of DSH as 'our hypothesis' though you say that later a few times. Because of this I adjusted the language later on.
...
% EMW5Dec20: Some reviewers can be sticklers for not putting discussion in the results (though I like it) ... so I suggest cutting what I cut below, as I am not sure you need it and your FHH statement is a little discussion-y. But do put it back if you prefer. 
...
% EMW5Dec20: Removed 'depended on' as people will want a statistical test for such a statement
...
\section*{Discussion}
% EMW5Dec20: You haven't really introduced what is a 'secondary' cue so I removed it here and a couple other places. 
...
% EMW5Dec20: check out edits here and in last sentence of previous paragraph
...
% EMW5Dec20: Again, check my edits
...
% EMW5Dec20: I still feel we need some transition for readers; see my suggested edits. Also check out edits in this paragraph.
...
% EMW5Dec20: I would go with 'interest' or 'public attention' or 'public interest' instead of 'conversation' in first sentence
