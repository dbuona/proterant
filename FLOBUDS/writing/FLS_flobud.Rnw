...
\noindent Among deciduous woody plants, the relative timing of flower and leaf phenology, or flower-leaf sequences (FLSs), may be particularly consequential to fitness in temperate regions where flowering prior to leaf development is common \citep{Rathcke_1985,Gougherty2018}.\linelabel{wind1} A number of pollen diffusion simulations and modeling studies have demonstrated that for wind-pollinated species, flowering-first increases pollen dispersal distances \citep{} and signifcantly reduces the amount of pollen interception from non-reproductive structures \citep{}. Other analyses have suggested that flowering-first is strongly correlated with the wind-pollination syndrome \citep{Buonaiuto2020, Friedman2009}, suggesting this phenological pattern is critical for the reproductive fitness of wind-pollinated taxa. While flowering-first is also prevelant in some biotically-pollinated taxa as well, its function is less clear in these taxa. Some authors suggest that flowering first increases visability of pollinators \citep{Janzen1967, Bukovac:2017aa,Forrest:2009aa} or alleviates hydraulic demand in dry conditions \citep{Gougherty2018,Franklin2016}. Alternatively, others suggest that in biotically-pollinated taxa, flowering-first FLSs are simply a by-product of selection for early flowering in general, and there is no unique function to the sequence \citep{Primack1987,MunguiaRosas2011}. While the function of FLS variation may vary amoung species, all flowering-first taxa engage with incure the same risks by beginning their reproductive investment from stored carbohydrades alone, at a time of year when these reseverse at are their lowest \citep{Primack 1987}, and the risk of damage from late frosts is highest \citep{}, and the cost-benefits of this tradeoff may be shifting due to anthropogenic climate\linelabel{wind2} change.\\ 
...
\noindent The impact\linelabel{wind3} on FLS shifts with climate change on the fitness of woody plants depends on the interaction between 1) the function of FLS for that species and 2) the direction and magnitude of the shift. For example, in wind-pollinated species that rely on a substantial flower-leaf interphase for effective pollen transport, decreasing FLS interphases with climate change may drive a reduction in pollination success as more pollen is intercepted by vegetation. Conversely, pollination efficiency could improve for species with lengthening FLS interphases. %A change in the FLS interphase of just a few days would likely have little impact on pollination, but if shifts were on the order of weeks, the impact on the pollination biology of a species could be significant.%
However, a proportionate FLS shift in biotically-pollinated taxa may have little impact on fitness, as larger magnitude shifts would need to occur before any signifcant impact on physiology or pollination success would be\linelable{wind4} incured.
%For example, because canopy structure influences the speed and direction of air flow \citep{Niklas1985, Jackson:1999aa}, decreasing FLS interphases could reduce pollen dispersal distances for wind-pollinated taxa \citep{Milleron2012}, which would ultimately impact population structure and gene flow across a landscape.\\
\noindent While several recent analyses have examined the funciton of FLS variation \citep[e.g.][]{Buonaiuto2020, Gougherty2018}, the factors that influence the magnitude and direction of FLS shifts are less well studied  \citep[but see][]{Ma2020:aa}. Predicting FLS shifts requires identifying the proximate mechanisms that drive or constrain FLS variation, and how these mechansims\linelabel{wind4} differ among species.\\
...
\noindent It\linelabel{buds1} is likely that FLS variation is moderated by other internal mechanisms like developmental construction \citep{Diggle1995}, or other physical contraints like infloresence architechture or bud type \citep{Pope2013}. For example, FLS variation in species with separate buds (buds containing either embryonic leaves or flowers) may be less constrained than species with mixed buds (buds containing both embryonic leaves and flowers together). Other factors like growth form (tree vs. shrub) or colonization-competition tradeoffs that have been show to influence the phenological sensitivty of specific phenophases \citep{} may also influence the sensitivty of phenological sequences to climate on\linelabel{buds2} the whole.\\

\noindent While FLS variation in woody plants is no doubt the product of complex interactions between species-specific biology and complex environmental imputs, studies that have attempted to identify the differences between reproductive and vegetative phenology in woody plants (mostly focused on crop species) have yielded two common explanations which we present below.
...
As we stated above, the impact of FLS shifts with climate change are reliant on both the function of FLS variation and the magnitude of FLS shifts. Just as previous anlyses suggest the the function of FLS variation may differ amoung species, our study highlights that the direction and magnitude of FLS shifts with climate change are also species-specific. We found that FLSs of some species were very sensitive to changing climate conditions, while other remain fairly resilient (Fig. \ref{fig:preddy}, Fig. \ref{fig:preddy_sp}).\\
...
\noindentThe species that maintained FLS structure across our climate change scenarios were biotically-pollinated, and generally shared a  strongly leafing-first FLS, with a fairly long FLS interphase (Fig \ref{fig:preddy}). As expected, these species tended to have mixed buds so there may be strong physical constraints on their FLSs. While a subset of biotically-pollinated taxa, those classified with ``concurrent" FLSs are expected to shift under some scenarios (see Fig \ref{fig:preddy}), but even if FLS variation does function to attact pollinators or alleviate hydraulic demand in these species, it is unlikely that FLS shifts would be of a large enough magnitude to impact either of these functions.

. By contrast, the species that were most sensitive to FLS shifts were monoecious, flowering-first, wind-pollinated shrubs (Fig \ref{fig:preddy}, Fig \ref{fig:preddy_sp}). This result supports other evidence that the reproductive phenology of wind-pollinated species may be more sensitive to climate change compared to biotically pollinated taxa \citep{Ziello:2012aa}. In all scenarios, our projections suggest that the flower-leaf interphase wiill decrease for thes species. Given this period is considered critical for successful pollination in these taxa \citep{}, this pattern suggests that these species, and flowering-first, wind-pollinated taxa in general, may face particular risk for reproductive performance reductions with climate change.\\

\noindent However, there are several caveats to this prediction. The function of FLS variation in wind-pollinated species suggest that leaves must create a substantial barrier to pollen\linelabel{wind5} movement.  In our study, we observed budburst, very beginning of leaf growth, a stage that is unlikely to contribute much to canopy structure. Most studies regarding pollen movement through forests have only considered open vs. full canopies and not the stages in between \citep{} so it is unclear at what point in leaf development wind-pollination might become impaired. While budburst and leaf expansion are typically correlated \citep{} and therefore the director of FLS shifts we observed would be expected to persit for later vegetative phenophases, if FLS's were measured from flowering the leafout, the duration interphase would longer than in our\linelabel{wind6} projections.\\

\noindent Secondly, in growth chamber experiments such as ours, it is difficult to evaluate the full duration of phenological events \citep{}. Shifts in the duration of flowering or period of leaf expansion could compensate for, or exacerbate the shifts in FLSs we observed. 

\noindent Finally, many wind-pollinated species are monecious or dioecious \citep{} and in several imporant families (e.g. \textit{Betulaceae}, \textit{Juglandaceace}), staminate flowers occur in seperate buds, while pistillate flowers occur in mixed buds \citep{}. This suggest that the phenology of pistilate flowers may be more tightly constrained by leaf phenology and if this is the case, even increases in the FLS interphases for flowering-first wind-pollinated taxa such as those observed in the field \citep[e.g.][]{Ma:2020aa} could adversly affect wind-pollination by distrupting floral synchrony by impact the temporal relationships between male and female\linelabel{wind7} flowers \citep{Alizoti2010,Mutke:2005aa,Elkassaby1991}.
...
\section*{Data Availability Statement:} Data will be available on KNB (https://knb.ecoinformatics.org/) upon publication. All modeling code will be made available upon request.
