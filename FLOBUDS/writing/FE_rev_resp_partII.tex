...
In this version, we have included detail about the treatment levels in each experiment in the ``Modeling Methods" section of the the Supporting information (lines \lineref{common1}-\lineref{common2}). In the main text we have added a reference to this section at line \lineref{common3} to highlight this.
...
\emph{Fig. 4c: please give more detail about why need these experimental efforts and what is the representation of each experimental effort.}
 ...
 We have adapted the main text (line \lineref{why1}) to elaborate on this design and updated the caption as well.
