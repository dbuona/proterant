...
%EMW20Feb22: Need to find a way to say more here instead of ' a particular challenge that can arise in experiments' ... try to find a good way to quickly encapsulate this problem for your audience. 
...
%EMW20Feb22: Seems relevant -- see my email from a week ago (ish). 
\textbf{Thing to think on: covationation or periodicity is a problem in studies that don't manipulate forcing e.g. Zohner paper. If you vary theromoperiod in step with photoperiod, your long photoperiod treatment gets more GDDs. I need to make this point somewhere, ideally, without restructuring the whole paper. But as I am saying this, I am realizing this problem might be less about interactions and more just about evaluating photoperiod effects in general. }\\
...
%EMW20Feb22: Add another cite below in first sentence ... you might also add the magnitude (e.g., estimated as 2-3X higher than photoperiod ... I am making up these numbers)
Studies repeatedly suggest that forcing is a more dominant cue than photoperiod for spring phenology \citep{CHUINE:2010wg}, therefore we should \emph{a priori} expect the covariation between photo- and thermo-period may result in an over-estimation of the photoperiod effect. %and a weaker estimate of the interaction between photoperiod and forcing. 
