...
We agree with the Reviewer and have made this change in line \lineref{harvest}.\\
...
Thanks to the reviewer for providing more precise language for this methodological step. We have adjusted the sentence accordingly (now line \lineref{embolism}).\\
...
%EMW24Mar2021: So, below I think you miss a change to toot your own horn on all you did -- it seems like you re-did all the analyses, re-did most of the figures (indicate which ones), and thus updated the results and discussion based on this. So say that clearly! Don't undersell the changes you made to address reviewer comments.
...
%EMW24Mar2021: Yep, I would adjust the caption from,`using three alternative methods for calculating chilling' to `using three alternative methods for calculating chilling (Utah Model, Chill hours, Dynamic Model, see this REF or R package for details)' ... if you want to do more you add a long caption giving a quick description of each chill model there with either originalc refs (1970s for Utah I think?) or an a Luedeling paper or R package that hits them all at once ... Either way the start of the reply is ... Good point, we should 
...
%EMW24Mar2021: See my email notes ... I am not sure I understand either. 
...
We thank the Reviewer for this idea and have incorporated their suggestion at line \lineref{sults1}.
...
\textbf{Any ideas?}\\
%EMW24Mar2021: Maybe ... Different environmental responses of flower and leaf buds drive .... 
...
We thank the Reviewer for this point, and we now explicitly mention the possible differences between tree and shrubs in line \lineref{shrub}. We think this is an important comparison and designed our study in hopes to address it more fully. Due to low flowering of two species, however, our final analysis consisted of far more shrub species than trees (seven shrubs, two under story trees and only one canopy tree). Thus, further analysis of this difference is now beyond the scope of our data.\\ %EMW24Mar2021: Check my edits here! (I try to put changes up front so reviewers see them easily in the reply, so I moved your change ... and was it two canopy trees we lost due to flowering data?) 
...
We have added this information in this line (line \lineref{minor2}).
...
We think this is a strong point and have added this to the manuscript in line \lineref{weak} .\\
