...
We agree with the Editor that this point is unclear. We change the sentence to simply suggest that predicting FLS shifts require a better understanding of how FLS patterns are dictated by the environment (line \lineref{abs2}).
