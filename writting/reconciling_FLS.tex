...
% EMW: Dan, are my edits to the topic sentence below in line with your general meaning in this paragraph? % DB I think this is redundant with 2 pars below. I'm trying a new one above.
%\indent Clearly, these definitions should link to the biological significance of different FLS, but, as we review below, different hypotheses suggest different defitions. % DB saving this topic sentence just in case.
