...
Green is the color of spring (cite Shwartz nature 1998 Green-wave Phenology), but any keen observer walking the Eastern deciduous forests early in the season would readily notice that it is often the subtle reds and yellows of emerging tree flowers that are the first harbingers of the season. Why do some tree species seasonally flower before leafing out? This trait, known as hysteranthy, is a feature common to deciduous forests, apparent in many commerically and ecologically important woody species, that has long been noted by botanists (cite old papers from 1900s). Several hypothesizes have been put forth, suggesting that this temporal trait is critial for the reproductive success of these species. but there has been little empirical investigation into the origins or significance of this pattern. Further, while the study of phenology, the timing of seasonal lifecycle events, has received increased attention in the past decades for it link to anthropogenic climate change, floral and leaf phenology have long been treated as disparate processes, and few studies incorperating observations of both, which could b applied to aid our understainding of hysteranthy, are available. Flowers and leaves share resource partitioning, and It has been shown that interactions between temperature and day length are cue of both floral and foliar phenology in trees (cite lots of people).  We have already seen significant shifts in phenology due to anthropogenic climate change. (cite a lot of people), but have no baseline degree will hysteranthous for evaluating how hysternathy has altered.This gap in the literature is particularly alarming, as  seasonal temperatures are projected to continue to change dramatically as a result of human industrial activity (cite any reasonable cliamte science). If hysteranthy is affected by climate change, this could have negative reproductive consequences and ultimately demographic consequences on many important species.
