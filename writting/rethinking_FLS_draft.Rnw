...
%EMW: This next section (lines 68-86 in PDF) feels very choppy to me and the main messages are hard to follow and I think needs the most work. I wonder if the first two paragraphs can be combined to define all terms ... e.g., "The terms hysteranthy, protanthy, proteranthy or precocious flowering describe plants that produce flowers before their leaves \citep{Lamont2011, Heinig1899}, while seranthy describes plants whose flowers open as their leaves approach their full size. [Then merge together neatly the contents of those two paragraphs.]" I think this may help one thing you are trying to do which is get the readers to recognize and know some important terms. More below .... 
\indent The terms hysteranthy, protanthy, proteranthy or precocious flowering describe plants that produce flowers before their leaves \citep{Lamont2011, Heinig1899}. A classic example of this FLS is \textit{Populus tremuloides}, which reaches peak flowering weeks before any sign of leaf development (Fig. \ref{fig:Figure 2}). These species tend to exhibit a degree of physiological specialization, such as the separation of flower and leaf buds. \\ %EMW: You just referred to ONE species, so 'these' species is unclear -- clarify. 
...
%EMW: This is too many questions for me, and for other readers I suspect. A couple well-placed questions in a manuscript can work -- too many can leave readers bewildered as to what the author is trying to communicate. Can you merge the below two paragraphs and make much clearer statements of what you are trying to communicate to the reader? Be careful of asking readers to memorize too many species -- make it easy for a reader to get the info you're trying to communicate. 
...
%EMW ... there is a connecting phrase or thought missing below ... see [].
\indent \indent Behind each prevailing FLS hypothesis are evolutionary drivers that yield the phenological sequences observed today. These mechanisms inherently predict different degrees of overlap between vegetative and floral phenophases [connecting thought missing]. Here, we review the current FLS hypotheses, identify the underlying biology of each, and clarify how much overlap between flowering and vegetative growth they predict.
