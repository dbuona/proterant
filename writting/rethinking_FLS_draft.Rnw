...
\indent\indent Flower-leaf sequences have traditionally been classified into qualitative categories that are almost always defined at the species level. The terms hysteranthy, protanthy, proteranthy or precocious flowering describe plants that produce flowers before their leaves. Synanthy describes species whose flowering period overlaps their leaf development and seranthy describes plants whose flowers open after their leaves emerge \citep{Lamont2011, Heinig1899}. There are two major ways that this catagorial approach hinders our ability to evaluate the function of FLS variation.\\

First, both flowering and leaf phenological sequences consist of multiple sub-stages, and this introduces significant ambiguity into how we interpret qualitative FLS descriptions. Consider a species who spring FLS is as follows:\\ Flower budburst\rightarrow leaf budburst\rightarrow flower open \rightarrow  leafout.\\

\indent Phenological observers might classify this species as hysteranthous because flower budburst proceeds leaf budburst. They would also be justified if they called this species synathous because flowers open during the time between leafbudburst and leafout. But they could just as easily catagorize this species as seranthous because flowers open after leaf budburst. If a species is called hysteranthous in one data set and synanthous in another, we have know way of knowing whether this discrepancy reflects temporal or geographic variability in FLS, or is simply an artifact of observer decision-making. This uncertainty hampers our ability to accurately test the existing FLS hypotheses because any statistical relationship between FLS and other traits is biased by the subjectivity of the original observer.\\

\indent Second, it is not clear that there is any biological significance to these particular determinations and these catagories obscure significant inter-specific difference in FLS. We have \textit{a priori} no reason to expect that a species whose flowers open two days after leaf budburst would be more similar to another species that flowers two week after leaf budburst than a species whose flowers open two days before, though the first two would both be classified as synanthous and the later as hysteranthous.\\

\indent We can solve this trough biology
