...
\indent We believe this work would be of interest to the readers of \textit{New Phytologist} for its relevance to both basic and applied plant biology. Because FLSs are a key component of the fitness of deciduous species \emph{6}, our new, more biologically accurate picture of FLSs will advance the study of the fundamental biology of this plant functional type in general. Further, phenological sequences are being reshaped climate change (Fig. \ref{fig:Figure 1}), and it is imperitive that we better understand the implications of these shifts as they may impact the ability of woody plants to persist in the future \emph{7}.\\
