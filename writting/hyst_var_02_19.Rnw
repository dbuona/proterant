...
\maketitle
Questions: \\
1. Should I more explicitly report the phylogeny results and interpret them?\\
2. Should I make some figure showing some population level variation in FLS in Europe to pair with figure three ( Oak variability)\\
3. What is useful in the PEP models?\\
4. Should I make Fig 4-5 a single, 4 pannel plot with a) MSTV, b) USFS, c) HF-Continuus, d) HF-binary\\
5. Is it okay to not include cold tolerance or seed mass/dispersal in the models given what I say about the substituteability of the selection diving early flowering?\\
6. Is it okay that MTSV USFS models use a ML framework and report 95\% bootstape intervals while the  HF models are baysian and report 50\% and 95\% CIs?\\
...
\begin{figure}
    \centering
    \includegraphics[width=.75\textwidth]{HFmeans.jpeg}
...
\end{figure}
 \begin{figure}
        \centering
          \includegraphics[width=.75\textwidth]{HFdissplot.jpeg}
    ...
    \begin{figure}
    \centering
    \includegraphics[width=\textwidth]{Mtsv_usfs_sidexside.jpeg}
    ...
    \end{figure}
        ...
        \begin{figure}
    \centering
    \includegraphics[width=\textwidth]{HF_cont_v_bin.jpeg}
