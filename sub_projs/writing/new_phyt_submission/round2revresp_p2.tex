...
We thank the reviewer for calling our attention to the need to clarify our description of this figure and we agree with their interpretation. In our previous submission we highlighted the sensitivity of our analyses to the specific phenophases used to define FLS (line \lineref{senssecond}):\\
...
We have modified this text in line \lineref{oofo} as the reviewer suggested to specifically reference the differences in the pollination syndrome estimates:\\
...
We agree with the reviewer's point here and have made this change in the manuscript (line \lineref{tradeoff1}).\\


\textit{L81: Not correct, Change ``more resistance to drought' to ``more sensitive to drought-induced xylem embolism"}\\

We have also made this change (line \lineref{hydro}).
