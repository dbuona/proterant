...
We have added explicit references to these drivers in lines \lineref{fruit}-\lineref{fruit2}, as well as incorporated them into alternative models using dispersal time or seed mass as a proxy for the early flowering hypothesis and included them in the Supporting Information (see Fig. \ref{fig:altpreds}). We found that using these predictors did not strongly affect our model inference but increased the uncertainty around the model estimates.
