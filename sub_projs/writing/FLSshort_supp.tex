...
\noindent For the quantitative Harvard Forest model, we estimated the phylogenetic signal for FLS (lambda) based  covarience of residuals among species. Estimated phylogenetic signals from all case studies are reported below (Fig. \ref{fig:Dstat}). Add citation for ggtree.  % I can probabalby elaborate on this. 
